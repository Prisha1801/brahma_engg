...
import { AQARDocHero } from '../common/data/heroData';
import { AQARDocData } from '../../data/data';
        ...
        <>
            ...
            <div style={{ maxWidth: '900px', margin: '50px auto', padding: '0 20px' }}>
                ...
                <table style={tableStyle}>
                    ...
                    <tbody>
                        {AQARDocData.length > 0 ? (
                            AQARDocData.map((item, index) => (
                                <tr
                                    key={item.id}
